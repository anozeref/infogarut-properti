          ...
          <form onSubmit={handleSubmit} className={styles.formBody}>
            <div className={styles.formSection}>
              ...
              <div className={styles.formGrid}>
                ...
                <div className={styles.formGroup}><label>Tipe Properti</label><select name="tipeProperti" value={form.tipeProperti} onChange={handleChange}><option>Rumah</option><option>Kos</option><option>Ruko</option><option>Tanah</option><option>Villa</option></select></div>
