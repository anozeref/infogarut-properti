...
const propertiesData = [
  ...
  { id: 6, title: "Ruko Baru Tarogong", jenis: "Dijual", tipe: "Ruko", location: "Tarogong", price: 900000000, periode: "-", status: "pending", owner: "Eka" },
  { id: 7, title: "Rumah Minimalis Garut", jenis: "Sewa", tipe: "Rumah", location: "Garut Kota", price: 3500000, periode: "6 bulan", status: "approved", owner: "Fani" },
...
const KelolaPropertiContent = () => {
  ...
  const renderPagination = (totalItems, currentPage, setPage) => {
    ...
    if (totalPages <= 1) return <div className={styles.pagination}><button disabled className={styles.pageBtn}>1</button></div>;
...
<div className={styles.container}>
  ...
  <div className={styles.section}>
    <p className={styles.subHeader}>
      Properti Disetujui ({approvedProperties.length})
    </p>
